						...
						<table id="example" style="width:100%">
					        ...
					        <tbody>
					            <tr>
					                <td>Kasutage</td>
					                <td>04/04/2023</td>
					                <td>Bienvenue sur Arcade !</td>
					                <td>
						                <div class="d-flex justify-content-end" style="gap: 10px;">
						                	<form method="POST" action="">
						                		<input type="hidden" name="dedi_id" value="0">
						                		<button type="submit" class="article__submit red">Refuser</button>
						                	</form>
						                	<form method="POST" action="">
						                		<input type="hidden" name="dedi_id" value="0">
						                		<button type="submit" class="article__submit">Valider</button>
						                	</form>
						                </div>
					                </td>
					            </tr>
